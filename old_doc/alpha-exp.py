...
def initialDistributingSetting(agents_num, distribution_type):
    ...
    if distribution_type == 0:
        ...
        for i in range(int(size)):
            ...
            al = random.uniform(0,1.0)
            al2 = random.uniform(0,1.0)
            temp.append(-al)
            temp.append(-al2)
...
def revealTheUnknownGameForEdge(network, agents_num, rewardDisMatrix, i, j, distribution):
    ...
    al = rewardDisMatrix[index,4]
    al2 = rewardDisMatrix[index,5]

    gameM = np.array([[a, 0], [0, b]])
    gameM = np.matrix(gameM)
    network.edge[i][j]['game'] = gameM
    network.edge[i][j]['alpha'] = [al, al2]
...
def calculateExpectedRewardInS(network, agent_no, action):
    ...
    for oppo_no in S:
        ...
        als = network.edge[agent_no][oppo_no]['alpha']

        # print(als)

        expectedReward_S.append(max(p * game[0,0] + (1 - p) * als[0], (1 - p) * game[1,1] + p * als[1]))
...
def calculateLambdaIndexInS_(network, agents_num, agent_no, action, rewardDisMatrix, c, sight, minimum, sec, neighbors_num):
    ...
    for neighbor in S_:
        ...
        index_in_dis_matrix = left * agents_num + right
        # U(a1,b1) U(a2,b2)
        al = rewardDisMatrix[index_in_dis_matrix, 4]
        al2 = rewardDisMatrix[index_in_dis_matrix, 5]

        # print(al)
        # print(al2)

        a1 = p * rewardDisMatrix[index_in_dis_matrix, 0] + (1 - p) * al
        b1 = p * rewardDisMatrix[index_in_dis_matrix, 1] + (1 - p) * al

        a2 = (1 - p) * rewardDisMatrix[index_in_dis_matrix, 2] + p * al2
        b2 = (1 - p) * rewardDisMatrix[index_in_dis_matrix, 3] + p * al2
...
# Mean average rewiring: 7.994666666666666
# Mean average reward: 759.156341915
# Mean highest reward: 1418.82660658
# Mean lowest reward: 266.494571309

# Mean average rewiring: 7.958333333333333
# Mean average reward: 950.585662433
# Mean highest reward: 1899.76205112
# Mean lowest reward: 287.865002304

# Mean average rewiring: 2.4399999999999995
# Mean average reward: 1277.05732049
# Mean highest reward: 2337.50909896
# Mean lowest reward: 545.26327557

# 100,4,16

# Mean average rewiring: 9.822000000000001
# Mean average reward: 707.428906942
# Mean highest reward: 1293.26463973
# Mean lowest reward: 272.309293208

# Mean average rewiring: 9.642666666666667
# Mean average reward: 940.805422483
# Mean highest reward: 1880.85908195
# Mean lowest reward: 279.070827172

# Mean average rewiring: 2.9153333333333333
# Mean average reward: 1274.23372871
# Mean highest reward: 2372.4354112
# Mean lowest reward: 509.247863218

# 500,4,16

# Mean average rewiring: 9.845733333333333
# Mean average reward: 694.19915036
# Mean highest reward: 1404.62101059
# Mean lowest reward: 168.805301544

# Mean average rewiring: 9.717200000000002
# Mean average reward: 949.970558142
# Mean highest reward: 2108.46218395
# Mean lowest reward: 180.9113041

# Mean average rewiring: 2.9396
# Mean average reward: 1275.85458353
# Mean highest reward: 2702.24870541
# Mean lowest reward: 385.35000029

# 500,8,16

# Mean average rewiring: 8.0
# Mean average reward: 741.973288591
# Mean highest reward: 1328.32962001
# Mean lowest reward: 242.43013875

# Mean average rewiring: 7.987666666666667
# Mean average reward: 952.315100319
# Mean highest reward: 1725.4203455
# Mean lowest reward: 296.936977155

# Mean average rewiring: 2.9348666666666663
# Mean average reward: 1081.21440157
# Mean highest reward: 1732.90591122
# Mean lowest reward: 479.551526101

# 1000,8,16

# Mean average rewiring: 7.9999666666666664
# Mean average reward: 742.332224903
# Mean highest reward: 1387.30632311
# Mean lowest reward: 218.846309415

# Mean average rewiring: 7.986766666666668
# Mean average reward: 950.060371628
# Mean highest reward: 1709.44848146
# Mean lowest reward: 266.633406916

# Mean average rewiring: 2.944266666666666
# Mean average reward: 1079.74535658
# Mean highest reward: 1834.33465257
# Mean lowest reward: 421.999721389
